...
\subsubsection{Local Control Units}
  ...
  \begin{table}[H]
  \caption{Local control units with their degree and cable restrictions for both cable types and direction.}
  \label{tab:data:lcu}
  \begin{center}
    \begin{tabular}{lc|cc|cc}
      & & \multicolumn{4}{c}{Data cable $d$} \\
      LCU type $s$ & Price [\euro/piece] & \multicolumn{2}{c|}{Copper} & \multicolumn{2}{c}{Fiberglass} \\
      && $[l^-_{s,d},u^-_{s,d}]$ & $[l^+_{s,d},u^+_{s,d}]$ & $[l^-_{s,d},u^-_{s,d}]$ & $[l^+_{s,d},u^+_{s,d}]$\\
      \midrule
