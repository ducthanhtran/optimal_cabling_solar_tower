...
\begin{table}
  \caption{Data cables with their limitations and costs.}
...
\begin{table}
  \caption{Power cables with their limitations and prices.}
  \begin{tabular}{l|cc|c}
    Cable & Max. capacity & Max. length [m] & Price [\euro/m] \\
    \toprule
...
\begin{itemize}
  \item How are heliostats partitioned?
  \item Data cable: use expensive switches that allow branching or consider paths
  \item How does the location affect solutions?
\end{itemize}
\end{frame}
