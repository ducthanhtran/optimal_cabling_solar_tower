...
Solution = NamedTuple('Solution', [('Edges', List[Edge]), ('Degrees': Dict[int,int]), ('EdgeTypes', Dict[Edge,int]), ('VertexCosts', Dict[int,float])])

def cost(sol: Solution, edge_costs: numpy.ndarray, vertex_costs: numpy.ndarray = None):
